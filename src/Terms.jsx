  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="p-10 max-w-[75ch] m-[0_auto]">
          <h1 className="font-bold text-neutral-700 text-xl">TERMS OF USE</h1>
          <p className="text-xs text-neutral-400 ml-5 py-3">
            Last updated December 28, 2023
          </p>
          <h2 className="text-lg font-bold text-neutral-600 py-5">
            AGREEMENT TO OUR LEGAL TERMS
          </h2>
          <p className="text-sm ml-5 mb-10">
            We are Norbile Foods Inc. ('Company', 'we', 'us', or 'our'), a
            company registered in Nigeria at shop 5, beside Edo CNS, Godwin way
            (limit road), sapele road., Benin city, Edo 300241. We operate the
            website Norbilefoods.vercel.app (the 'Site'), as well as any other
            related products and services that refer or link to these legal
            terms (the 'Legal Terms') (collectively, the 'Services'). You can
            contact us by phone at +2348056765391, email at
            Norbilefoods@gmail.com, or by mail to shop 5, beside Edo CNS, Godwin
            way (limit road), sapele road., Benin city, Edo 300241, Nigeria.
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity 'you', and
            Norbile Foods Inc., concerning your access to and use of the
          ...
          <hr />
          <p className="py-10 text-xs font-bold text-red-400">
          ...
          <h2 className="font-bold text-lg text-neutral-600 py-2">
            TABLE OF CONTENTS
          </h2>

          <ul className="list-decimal pl-10 text-sm space-y-4 py-4">
            <li>OUR SERVICES</li>
          ...
          <p className="text-sm text-neutral-500 py-10">
            1. OUR SERVICES:
            <br />
            <br /> The information provided when using the Services is not
            ...
            <br />
            <br /> Our intellectual property We are the owner or the licensee of
            ...
            personal, non-commercial use only. Your use of our Services Subject
            ...
            Legal Terms, please address your request to: Norbilefoods@gmail.com.
            ...
            submissions Please review this section and the 'PROHIBITED
            ...
            you or that you have the necessary rights and licences to submit
            ...
            <br />
            <br /> By using the Services, you represent and warrant that: (1)
            ...
            permission to use the Services; (5) you will not access the Services
            ...
            unauthorised purpose; and (7) your use of the Services will not
            ...
            <br />
            <br /> You may be required to register to use the Services. You
            ...
            <br />
            <br /> 6. PURCHASES AND PAYMENT
            <br />
            <br /> We accept the following forms of payment: - Visa - Mastercard
            ...
            time. All payments shall be in Naira. You agree to pay all charges
            at the prices then in effect for your purchases and any applicable
            shipping fees, and you authorise us to charge your chosen payment
            ...
            <br /> 7. RETURN POLICY
            <br />
            <br /> All sales are final and no refund will be issued.
            <br />
            ...
            feedback for any purpose without compensation to you. We do not
            ...
            <br />
            <br /> 11. GUIDELINES FOR REVIEWS
            <br />
            <br /> We may provide you areas on the Services to leave reviews or
            ...
            <br />
            <br /> 12. THIRD-PARTY WEBSITES AND CONTENT
            <br />
            <br /> The Services may contain (or you may be sent via the Site)
            ...
            advised the Services are hosted in Nigeria. If you access the
            ...
            Nigeria, and you expressly consent to have your data transferred to
            and processed in Nigeria.
            <br />
            <br /> 16. TERM AND TERMINATION
            <br />
            <br /> These Legal Terms shall remain in full force and effect while
            ...
            <br />
            <br /> 17. MODIFICATIONS AND INTERRUPTIONS
            <br />
            <br /> We reserve the right to change, modify, or remove the
            ...
            any information on our Services. We also reserve the right to modify
            ...
            <br /> 18. GOVERNING LAW
            <br />
            <br /> These Legal Terms shall be governed by and defined following
            the laws of Nigeria. Norbile Foods Inc. and yourself irrevocably
            ...
            <br />
            <br /> You agree to irrevocably submit all disputes related to these
            Legal Terms or the legal relationship established by these Legal
            Terms to the jurisdiction of the Nigeria courts. Norbile Foods Inc.
            ...
            <br />
            <br /> IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE
            ...
            23. INDEMNIFICATION
            <br />
            <br /> You agree to defend, indemnify, and hold us harmless,
            ...
            is subject to this indemnification upon becoming aware of it. <br />
            <br />
            24. USER DATA
            <br />
            <br /> We will maintain certain data that you transmit to the
            ...
            <br />
            <br /> 25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
            <br />
            <br />
            ...
            <br />
            <br /> 26. CALIFORNIA USERS AND RESIDENTS
            <br />
            <br /> If any complaint with us is not satisfactorily resolved, you
            ...
            <br />
            28. CONTACT US <br />
            <br /> In order to resolve a complaint regarding the Services or to
            receive further information regarding use of the Services, please
            contact us at: Norbile Foods Inc. shop 5, beside Edo CNS, Godwin way
            (limit road), sapele road. Benin city, Edo 300241 Nigeria Phone:
            +2348056765391 norbilefoods@gmail.com
          </p>
        </div>
      </div>
      <Footer />
